...
class MainFragment : Fragment(),View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        when (p0!!.id){
            R.id.view_balance_btn-> navController.navigate(R.id.action_mainFragment_to_viewBalance)
            ...
            R.id.view_transactions_btn-> {
                navController.navigate(R.id.action_mainFragment_to_viewTransactions)
            }
        }
