...
class SpecifyAmountFragment : Fragment(),View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        recipient = requireArguments()!!.getString("recipent").toString()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<Button>(R.id.send_btn_spic).setOnClickListener (this)
        view.findViewById<Button>(R.id.cancel_btn_spic).setOnClickListener (this)
    ...
    override fun onClick(p0: View?) {
        when (p0!!.id){
            ...
            R.id.cancel_btn_spic-> requireActivity().onBackPressed()
        }
    }
}
